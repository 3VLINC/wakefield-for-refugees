...
export const GetInvolved: React.FC = () => {
    ...
    return <MainDiv id="get-involved">
        ...
        <p>The core group sets the long-term strategy of the organition and mobilizes around particular projects. Members belong to one or more subcommittees that tackle things such as fundraising, communications or basic needs. </p>
        ...
        <p>When families arrive they need help navigating their new surroundings. Point persons act as a families single point of contact for help. Whether it be registering children for school, navigating public transportation or finding work, point persons laise with our larger group of volunteers
